...
Building **800G/1.6T intrarack optical links** at AWS: link validation (100G/lane, OSFP), in-band 1PPS timing over existing optical links, and side-channel telemetry on the same fiber.

## Experience

| When | Role |
|------|------|
| **2026–present** | **AWS** — Optical Network Development Engineer, Cupertino |
| **2020–2026** | **Apple** — Silicon Photonics Lead, Camera Technology Group |
...
- **53** granted US patents (optical phased arrays, LiDAR, silicon photonics)
- **5,000+** citations; *Nature* and *Nature Communications* author
- **$3.9M+** as PI on DOE and DoD SBIR programs
- Founding proposal co-author, **AIM Photonics** ($600M+ institute)
- **Deep Learning** and **Machine Learning** specializations (DeepLearning.AI / Andrew Ng)
...
*Resume source: [ehsan_resume](https://github.com/farrox/ehsan_resume)*
